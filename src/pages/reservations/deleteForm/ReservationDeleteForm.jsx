...
import classes from './ReservationDeleteForm.module.scss';
import {reservationService} from "../../../services/ReservationService";

const ReservationDeleteForm = ({type, id, cancel}) => {

    const queryClient = useQueryClient();

    const del = useMutation((data) => reservationService.delete(data?.id)
        .then(r => {
            message.success(t('reservations.success-delete'));
    ...
    const get = (id) => {
        return reservationService.getReservationById(id).then(res => {
            reset(res);
        })
    ...
    useQuery(['reservation-single', id], () => get(id), {
